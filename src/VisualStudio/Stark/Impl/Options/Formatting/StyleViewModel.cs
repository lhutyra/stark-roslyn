...
";
        ...
        internal StyleViewModel(OptionSet optionSet, IServiceProvider serviceProvider) : base(optionSet, serviceProvider, LanguageNames.Stark)
        {
        ...
        private void AddParenthesesOptions(OptionSet optionSet)
        {
            AddParenthesesOption(
                LanguageNames.Stark, optionSet, CodeStyleOptions.ArithmeticBinaryParentheses,
            ...
            AddParenthesesOption(
                LanguageNames.Stark, optionSet, CodeStyleOptions.OtherBinaryParentheses,
                CSharpVSResources.In_other_binary_operators,
                new[] { s_otherBinaryAlwaysForClarity, s_otherBinaryNeverIfUnnecessary },
                defaultAddForClarity: true);

            AddParenthesesOption(
                LanguageNames.Stark, optionSet, CodeStyleOptions.RelationalBinaryParentheses,
            ...
            AddParenthesesOption(
                LanguageNames.Stark, optionSet, CodeStyleOptions.OtherParentheses,
        ...
        private void AddParameterOptions(OptionSet optionSet, string parameterPreferencesGroupTitle)
        {
            ...
            AddUnusedParameterOption(LanguageNames.Stark, optionSet, parameterPreferencesGroupTitle, examples);
        }
    }
}
