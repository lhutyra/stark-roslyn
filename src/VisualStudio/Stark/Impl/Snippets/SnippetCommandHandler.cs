...
namespace StarkPlatform.VisualStudio.LanguageServices.CSharp.Snippets
{
    ...
    [ContentType(CodeAnalysis.Editor.ContentTypeNames.StarkContentType)]
        ...
        ICommandHandler<SurroundWithCommandArgs>
    {
        ...
        protected override AbstractSnippetExpansionClient GetSnippetExpansionClient(ITextView textView, ITextBuffer subjectBuffer)
        {
            ...
            {
                expansionClient = new SnippetExpansionClient(ThreadingContext, Guids.StarkLanguageServiceId, textView, subjectBuffer, EditorAdaptersFactoryService);
