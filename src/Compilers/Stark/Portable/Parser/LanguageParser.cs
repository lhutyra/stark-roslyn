...
namespace StarkPlatform.CodeAnalysis.Stark.Syntax.InternalSyntax
{
    ...
    internal partial class LanguageParser : SyntaxParser
    {
        ...
        private struct NamespaceBodyBuilder
        {
            ...
            public SyntaxListBuilder<ImportDirectiveSyntax> Usings;
            ...
            public NamespaceBodyBuilder(SyntaxListPool pool)
            {
                ...
                Usings = pool.Allocate<ImportDirectiveSyntax>();
        ...
        private ImportDirectiveSyntax ParseUsingDirective()
        {
        ...
        private AttributeSyntax ParseAttributeDeclaration()
        {
...
parse_member_name:;
        ...
        private DestructorDeclarationSyntax ParseDestructorDeclaration(SyntaxListBuilder<AttributeSyntax> attributes, SyntaxListBuilder modifiers)
        {
...
tryAgain:
        ...
        private static bool WasFirstVariable(Stark.Syntax.VariableDeclaratorSyntax variable)
        {
            var parent = GetOldParent(variable) as Stark.Syntax.VariableDeclarationSyntax;
            if (parent != null)
            {
        ...
        private static VariableFlags GetOriginalVariableFlags(Stark.Syntax.VariableDeclaratorSyntax old)
        {
        ...
        private static bool CanReuseVariableDeclarator(Stark.Syntax.VariableDeclaratorSyntax old, VariableFlags flags, bool isFirst)
        {
            if (old == null)
            {
                return false;
        ...
        {
            if (this.IsIncrementalAndFactoryContextMatches && CanReuseVariableDeclarator(this.CurrentNode as Stark.Syntax.VariableDeclaratorSyntax, flags, isFirst))
            {
                localFunction = null;
        ...
        private FieldDeclarationSyntax ParseConstantFieldDeclaration(SyntaxListBuilder<AttributeSyntax> attributes, SyntaxListBuilder modifiers, SyntaxKind parentKind)
        {
...
tryAgain:
        ...
        private ParameterSyntax ParseLambdaParameter()
        {
            ...
            var parameter = _syntaxFactory.Parameter(default(SyntaxList<AttributeSyntax>), modifiers.ToList(), paramType, paramName, null);
            _pool.Free(modifiers);
            return parameter;
        }
