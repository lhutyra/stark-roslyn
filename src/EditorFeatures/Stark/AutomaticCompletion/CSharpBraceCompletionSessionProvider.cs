...
using StarkPlatform.CodeAnalysis.Editor.CSharp.AutomaticCompletion.Sessions;
...
{
    [ExportLanguageService(typeof(IEditorBraceCompletionSessionFactory), LanguageNames.Stark), Shared]
