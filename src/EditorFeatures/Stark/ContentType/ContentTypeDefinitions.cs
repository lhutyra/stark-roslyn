...
namespace StarkPlatform.CodeAnalysis.Editor.CSharp.ContentType
{
    internal static class ContentTypeDefinitions
    {
        ...
        /// </summary>
        [Export]
        [Name(ContentTypeNames.StarkContentType)]
        [BaseDefinition(ContentTypeNames.StarkRoslynContentType)]
        public static readonly ContentTypeDefinition CSharpContentTypeDefinition;

        [Export]
        [Name(ContentTypeNames.StarkSignatureHelpContentType)]
