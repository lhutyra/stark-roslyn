...
namespace StarkPlatform.CodeAnalysis.Editor.CSharp.LineSeparator
{
    [ExportLanguageService(typeof(ILineSeparatorService), LanguageNames.Stark), Shared]
    internal class CSharpLineSeparatorService : ILineSeparatorService
    {
        ...
        private static void ProcessUsings(SyntaxList<ImportDirectiveSyntax> usings, List<TextSpan> spans, CancellationToken cancellationToken)
        {
