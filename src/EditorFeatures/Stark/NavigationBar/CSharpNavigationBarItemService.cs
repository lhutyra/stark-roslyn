...
using StarkPlatform.CodeAnalysis.Editor.Extensibility.NavigationBar;
using StarkPlatform.CodeAnalysis.Editor.Implementation.NavigationBar;
...
namespace StarkPlatform.CodeAnalysis.Editor.CSharp.NavigationBar
{
    [ExportLanguageService(typeof(INavigationBarItemService), LanguageNames.Stark), Shared]
