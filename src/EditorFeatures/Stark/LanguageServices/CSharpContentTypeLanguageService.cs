...
{
    [ExportContentTypeLanguageService(ContentTypeNames.StarkContentType, LanguageNames.Stark), Shared]
    internal class CSharpContentTypeLanguageService : IContentTypeLanguageService
    {
        ...
        {
            return _contentTypeRegistry.GetContentType(ContentTypeNames.StarkContentType);
        }
    }
}
