...
using RoslynCompletionTrigger = StarkPlatform.CodeAnalysis.Completion.CompletionTrigger;
...
{
    using CompletionTrigger = StarkPlatform.CodeAnalysis.Completion.CompletionTrigger;
