...
using StarkPlatform.CodeAnalysis.ConvertForEachToFor;
...
namespace StarkPlatform.CodeAnalysis.Stark.ConvertForEachToFor
{
        ...
        AbstractConvertForEachToForCodeRefactoringProvider<ForEachVariableStatementSyntax>
    {
        ...
        protected override ForEachVariableStatementSyntax GetForEachStatement(TextSpan selection, SyntaxToken token)
        {
            ...
            var scope = TextSpan.FromBounds(foreachStatement.ForEachKeyword.Span.Start, foreachStatement.Expression.Span.End);
            ...
            SyntaxGenerator generator, ForEachInfo foreachInfo, SyntaxNode collectionVariableName, SyntaxToken indexVariable)
        {
            ...
            if (bodyBlock.Statements.Count > 0)
            {
                ...
                var variableStatement = AddItemVariableDeclaration(
                    ...
                    foreachStatement.Variable.GetFirstToken(), foreachInfo.ForEachElementType, collectionVariableName, indexVariable);
