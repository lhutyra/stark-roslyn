...
using StarkPlatform.CodeAnalysis.ConvertForToForEach;
...
namespace StarkPlatform.CodeAnalysis.Stark.ConvertForToForEach
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = nameof(CSharpConvertForToForEachCodeRefactoringProvider)), Shared]
            ...
            VariableDeclarationSyntax>
    {
            ...
            ITypeSymbol iterationVariableType, OptionSet optionSet)
        {
            ...
            return SyntaxFactory.ForEachVariableStatement(
                SyntaxFactory.IdentifierName(foreachIdentifier),
                collectionExpression,
                forStatement.Statement is BlockSyntax ? (BlockSyntax)forStatement.Statement : SyntaxFactory.Block(forStatement.Statement));
        }
